...
def get_empirical_homophily(fm, e_MM, e_Mm, e_mM, e_mm, plo_M, plo_m):
  ...
  eq1 = Eq( (  (fm * hmm * (1-bo_M)) / ((fm * hmm * (1-bo_M)) + (fM * hmM * (1-bo_m))) )  , p_mm)
  eq2 = Eq( hmm + hmM , 1)
  eq3 = Eq( (  (fM * hMM * (1-bo_m)) / ((fM * hMM * (1-bo_m)) + (fm * hMm * (1-bo_M))) )  , p_MM)
  eq4 = Eq( hMM + hMm , 1)
