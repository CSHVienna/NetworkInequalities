...
from netin import NewPATCH, PATCH_LINK_FORMATION_MECHANISMS
from netin.utils import constants as const


class TestNewPATCH(object):
    ...
    def test_patch_case_1(self):
        ...
        tc = 0.5
        seed = 1234
        g = NewPATCH(n=n, k=k, f_m=f_m, h_MM=h_MM, h_mm=h_mm, tc=tc, lfm_local=PATCH_LINK_FORMATION_MECHANISMS.H, lfm_global=PATCH_LINK_FORMATION_MECHANISMS.PAH, seed=seed)
        g.generate()
    ...
    def test_patch_case_5(self):
        ...
        with pytest.raises(TypeError, match="missing 1 required positional argument: 'tc'"):
            _ = NewPATCH(n=n, k=k, f_m=f_m, h_MM=h_MM, h_mm=h_mm, lfm_local=PATCH_LINK_FORMATION_MECHANISMS.H, lfm_global=PATCH_LINK_FORMATION_MECHANISMS.PAH, seed=seed)
    ...
    def test_patch_case_6(self):
        ...
        with pytest.raises(TypeError, match="missing 2 required positional arguments: 'h_mm' and 'h_MM'"):
            _ = NewPATCH(n=n, k=k, f_m=f_m, tc=tc, lfm_local=PATCH_LINK_FORMATION_MECHANISMS.H, lfm_global=PATCH_LINK_FORMATION_MECHANISMS.PAH, seed=seed)
    ...
    def test_patch_case_7(self):
        ...
        with pytest.raises(TypeError, match="missing 3 required positional arguments: 'h_mm', 'h_MM', and 'tc'"):
            _ = NewPATCH(n=n, k=k, f_m=f_m, lfm_local=PATCH_LINK_FORMATION_MECHANISMS.H, lfm_global=PATCH_LINK_FORMATION_MECHANISMS.PAH, seed=seed)
    ...
    def test_patch_ccf_increase(self):
        ...
        l_g = [NewPATCH(n=n, k=k, f_m=f_m, h_MM=h, h_mm=h, tc=p_tc, lfm_local=PATCH_LINK_FORMATION_MECHANISMS.H, lfm_global=PATCH_LINK_FORMATION_MECHANISMS.PAH, seed=seed) for p_tc in tc]
        l_ccf = []
        for g in l_g:
            g.generate()
